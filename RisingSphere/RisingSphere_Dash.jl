...
) do n_run, nel_x, nel_z, n_timesteps, input_density, input_matrix, input_radius, input_width
    @show n_run, nel_x, nel_z, n_timesteps, input_density, input_matrix, input_radius, input_width
    str = "Timestep: $n_run"
